...
ARG APP_PATH=/icalia-actions/cc-prepare-test-reporting
...
ARG APP_PATH=/icalia-actions/cc-prepare-test-reporting
COPY --from=builder --chown=node:node ${APP_PATH} /icalia-actions/cc-prepare-test-reporting
WORKDIR /icalia-actions/cc-prepare-test-reporting
